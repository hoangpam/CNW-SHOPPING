...
(function($) {
	...
	/*--------------------------------------------------------------
       START Countdown JS
      --------------------------------------------------------------*/ 
	  $('#countdown').countdown('2021/11/10', function(event) {
		var $this = $(this).html(event.strftime(''
			
			+ '<div><strong>%D</strong> <br />Ngày </div>'
			+ '<div><strong>%H</strong> <br />Giở </div>'
			+ '<div><strong>%M</strong> <br />Phút </div>'
			+ '<div class="sec"><strong>%S</strong> <br />Giây</div>'));
		});
	/*--------------------------------------------------------------
